...
<div class="post-body-img-container">
    <img src="{{ '/posts/images/Ailthir Chibi.png' | url }}" class="post-body-img" />
...
<br><br>
If you have read this post all the way until here, thank you for reading! I don't have an RSS feed or anything like that that you can subscribe to (I have no idea how to set that up yet), but I'll keep working on this blog, and my Neocities site as well. For a rundown of how I set this blog up, you can check out my first Dev Log (if you can even call it that) for this blog here.
<br><br>
