---
title: Petrapixel's Advent Calendar Challenge (2025) - Week 2
author: kanekos
date: 2025-12-08
tags: ["personal", "advent calendar"]
image: /posts/images/advent_calendar/advent_calendar.png
imageAlt: Advent Calendar Challenge
...
### 🎁 Day 8 - Small Circle <a name="day-8"></a>

<details class="challenge-box">
    <summary>
        <b>Challenge</b>
    </summary>
    <i>If you're currently following more than 50 people on a social media (e.g. instagram, twitter, ...), reduce it to 50. If you're following less than 50 already, reduce it to 25. Focus on what/who you really care about, and get rid of the rest. You'll love it, I swear.
    </br></br>
    Bonus challenge for tryhards & go-getters:
    </br></br>
   Reset your instagram explore page/suggestions so that they are not interesting to you anymore. (This can be done in the settings.)</i>
</details>
<br>
...
We're down to 374 accounts.

Look I really tried my best 😂 But my Twitter following list has pretty much become a time capsule of my interests, so I couldn't bring myself to unfollow a lot of old accounts that I have fond memories of, even if they are inactive or I'm not actively involved in the fandom anymore.
